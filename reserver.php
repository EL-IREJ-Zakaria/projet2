                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <h5>Tarif</h5>
                                    <p class="mb-1"><?php echo number_format($chambre['prix_nuit'], 2, ',', ' '); ?> € x <?php echo $nb_nuits; ?> nuits</p>
                                    <p class="text-gold fw-bold">Total: <?php echo number_format($prix_total, 2, ',', ' '); ?> €</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span><?php echo number_format($chambre['prix_nuit'], 2, ',', ' '); ?> €</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="d-flex justify-content-between fw-bold">
                                <span>Total</span>
                                <span class="text-gold"><?php echo number_format($prix_total, 2, ',', ' '); ?> €</span>
                            </div>
                        </div>
                    </div>
